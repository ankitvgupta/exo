...
export function OfflineBanner() {
  ...
  return (
    <div
      className={`${getRendererPlatform().isMac ? "titlebar-drag pl-20" : "pl-4"} bg-amber-50 dark:bg-amber-900/30 border-b border-amber-200 dark:border-amber-800 pr-4 py-2 flex items-center justify-between`}
    >
